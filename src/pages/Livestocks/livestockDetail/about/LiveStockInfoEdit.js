...
import { ImageUpload, Spinner, TabPane, CustomInput } from "../../../../ComponentsV2";
  ...
  return (
    <form onSubmit={handleSubmit(handleFormSubmit)} style={{ width: "100%" }}>
      ...
      >
        ...
        />
        {isEdit ? (
          <ImageUpload onUpload={setLivestockImg} />
        ) : (
          <img
            style={{
              height: "22vh",
        ...
        <Stack direction={"column"} gap={2} mt={2}>
          ...
          <CustomInput
            ...
            label={"Gender"}
            select={true}
            selectData={[{label:'Male', value:'male'}, {label:'Female', value:'female'}]}
            value={info?.gender}
