...
import { useAddBmController, setNodeData } from "../../../../../context/addBm";
...
const NodeDetails = ({ title }) => {
  ...
  const { branchPincode, branchCity, branchState, branchCountry, nodeData } =
    controller;
                      ...
                      setNodesData((s) => {
                        return [
                          ...s,
                          {
                            ...
                            depth3: "",
                            nodeAddress: "",
                            nodePincode: branchPincode,
                            nodeCity: branchCity,
                            nodeState: branchState,
                            nodeCountry: branchCountry,
                            nodeGeoLatitude: "",
                            nodeGeoLongitude: "",
                          },
                        ];
